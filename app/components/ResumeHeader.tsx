      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="shrink-0">
          <Image
            ...
            width={200}
            height={200}
            className="rounded-xl border-4 border-white/20 shadow-xl w-40 h-40 sm:w-48 sm:h-48 md:w-52 md:h-52 object-cover"
            priority
          />
        </div>
        <div className="flex-1 text-center sm:text-left">
          ...
          {/* Contact Links */}
          <div className="flex mt-5 flex-wrap gap-3 sm:gap-4 md:gap-6 text-sm justify-center sm:justify-start sm:text-base">
            <a
