export default function Home() {
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-green-50 via-blue-50 to-purple-50 font-sans dark:from-green-900 dark:via-gray-900 dark:to-purple-900">
      <main className="flex min-h-screen w-full max-w-4xl flex-col items-center justify-center py-16 px-8 text-center">
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-green-700 dark:text-green-300 text-sm mt-1">
                  This resume is currently being built with more caffeine than sleep. 
                  Please excuse the digital dust while I code my way to greatness! ☕️💻
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="text-center">
          ...
          <p className="text-gray-500 dark:text-gray-400 max-w-lg mx-auto">
            My full resume with all the fancy animations, project showcases, and probably 
            way too many hover effects. Because why use one CSS transition when you can use twenty? 🎨
          </p>
